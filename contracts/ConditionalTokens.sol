...
import "./interfaces/RewardReciever5.sol";
...
contract ConditionalTokens is ERC1155 {
    ...
    mapping(bytes32 => ConditionData) conditions;
    ...
    function prepareCondition(address oracle, bytes32 questionId, uint outcomeSlotCount) external {
        ...
        _saveCondition(oracle, questionId);
    ...
    function splitPosition(
        ...
        require(amount + taxes == amount * 1.1, "Incorrect amount of taxes set!");

        require(_payTaxes(collateralToken, conditionId, taxes), "Could not pay taxes.");
    ...
    function _saveCondition( bytes32 conditionId, address oracle, bytes32 questionId ) internal {
